...
; This version ensures that despite the record-oriented design of FCBs, only the string
; is written.
;--------------------------------------------------------------------------------------
...
step3:		cld
		...
		mov	word [fcb+0x0E],13	; change record size to 13 (same as the length of data)
