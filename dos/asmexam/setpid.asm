...
; SETPID.COM
;
; Demonstrates using (well, abusing) INT 21h AH=0x50 to change the "current" PSP in
; order to allocate memory that DOS will associate with the process that ran us, rather
; than with us. MS-DOS 2.0 or higher.
;
...
; ========================================================
; set the "process ID" to the parent's PSP segment so that
; Allocation #2 is charged to our parent process
; ========================================================
		mov	ah,0x50		; (undocumented) set current process ID
		mov	bx,[cs:0x16]
		int	21h
