...
; GET4G_8M.COM
;
; Write to disk anything visible in the 0xFF800000 to 0xFFFFFFFF area.
; Write to disk the 8MB visible just under 4GB.
;
...
;
; This program captures 8MB of data, as 128 files 64KB each. If the program detects that
...
hello_str:	db	'This program will write the 4GB-8MB ROM region to disk in',13,10
		db	'64KB fragments. Disk space required: 8MB. Please read GET4G.TXT.',13,10
		db	13,10,'$'

rd_seg_whole:	db	0x00,0x00		; NTS: see what I did here? rd_seg points to rd_seg_whole+2
rd_seg:		db	0x80,0xFF
fname:		db	'FF800000.ROM',0,'$'
		;	    ^
		;        012345678901
