...
; GET4G_4M.COM
;
; Write to disk anything visible in the 0xFFC00000 to 0xFFFFFFFF area.
; Write to disk the 4MB visible just under 4GB.
;
...
;
; This program captures 4MB of data, as 64 files 64KB each. If the program detects that
...
hello_str:	db	'This program will write the 4GB-4MB ROM region to disk in',13,10
		db	'64KB fragments. Disk space required: 4MB. Please read GET4G.TXT.',13,10
		db	13,10,'$'

rd_seg_whole:	db	0x00,0x00		; NTS: see what I did here? rd_seg points to rd_seg_whole+2
rd_seg:		db	0xC0,0xFF
fname:		db	'FFC00000.ROM',0,'$'
		;	    ^
		;        012345678901
