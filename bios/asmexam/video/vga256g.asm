...
; VGA256G.COM
; 
; Setup VGA 320x240x256 and display a bitmap. This is done (as usual) by setting
...
; the boot logo and within DISPDIB.DLL to provide 320x240x256 fullscreen modes for
