...
; GET4G.COM
;
; Write to disk anything visible in the 0xFFF00000 to 0xFFFFFFFF area.
; Write to disk the 1MB visible just under 4GB.
;
...
hello_str:	db	'This program will write the 4GB - 1MB ROM region to disk in',13,10
		db	'64KB fragments. Disk space required: 1MB. Please read GET4G.TXT.',13,10
		db	13,10,'$'
...
rd_seg:		db	0xF0,0xFF		; starting at 0xFFF00000
hexes:		db	'0123456789ABCDEF'
fname:		db	'FFF00000.ROM',0,'$'
		;	    ^
		;        012345678901
