# Windows 16-bit bimodal (real & protected mode) mode target
...
# eval the targetdir
_win16b_t1=$(subst 86,,$(patsubst win16b/%,%,$(target_subdir)))
_win16b_t=$(subst 31_,,$(subst 30_,,$(subst 20_,,$(subst 10_,,$(_win16b_t1)))))

ifeq ($(findstring 10,$(_win16b_t1)),10)
  TARGET_WINDOWS_VERSION=10
endif
ifeq ($(findstring 20,$(_win16b_t1)),20)
  TARGET_WINDOWS_VERSION=20
endif
ifeq ($(findstring 30,$(_win16b_t1)),30)
  TARGET_WINDOWS_VERSION=30
endif
ifeq ($(findstring 31,$(_win16b_t1)),31)
  TARGET_WINDOWS_VERSION=31
endif

ifeq ($(findstring 0,$(_win16b_t)),0)
  W_CPULEVEL=0
endif
ifeq ($(findstring 2,$(_win16b_t)),2)
  W_CPULEVEL=2
endif
ifeq ($(findstring 3,$(_win16b_t)),3)
  W_CPULEVEL=3
endif
ifeq ($(findstring 4,$(_win16b_t)),4)
  W_CPULEVEL=4
endif
ifeq ($(findstring 5,$(_win16b_t)),5)
  W_CPULEVEL=5
endif
ifeq ($(findstring 6,$(_win16b_t)),6)
  W_CPULEVEL=6
endif

ifeq ($(findstring c,$(_win16b_t)),c)
  W_MMODE=c
endif
ifeq ($(findstring s,$(_win16b_t)),s)
  W_MMODE=s
endif
ifeq ($(findstring m,$(_win16b_t)),m)
  W_MMODE=m
endif
ifeq ($(findstring l,$(_win16b_t)),l)
  W_MMODE=l
endif
ifeq ($(findstring h,$(_win16b_t)),h)
  W_MMODE=h
endif
ifeq ($(findstring f,$(_win16b_t)),f)
  W_MMODE=f
endif

ifeq ($(findstring o,$(_win16b_t)),o)
TARGET_CPUONLY=1
endif

ifeq ($(findstring x,$(_win16b_t)),x)
TARGET_EXTLIB=1
endif

ifeq ($(findstring d,$(_win16b_t)),d)
TARGET_DEBUG=1
W_DEBUG=-d3
endif

# compiler flags
_win16b_defs = -dTARGET_WINDOWS=1 -dTARGET_WINDOWS_WIN16=1 -dTARGET_BITS=16 -dTARGET_AUTOMODE=1 -dTARGET_CPU=$(W_CPULEVEL) -dTARGET_WINDOWS_GUI=1 -d_WINDOWS_16_=1
ifeq ($(TARGET_CPUONLY),1)
_win16b_defs += -dTARGET_CPUONLY=1
endif
ifeq ($(TARGET_EXTLIB),1)
_win16b_defs += -dTARGET_EXTLIB=1
endif
ifeq ($(TARGET_DEBUG),1)
_win16b_defs += -dTARGET_DEBUG=1
endif
ifneq ($(TARGET_WINDOWS_VERSION),)
_win16b_defs += -dTARGET_WINDOWS_VERSION=$(TARGET_WINDOWS_VERSION)
endif
