...
ifeq ($(findstring 0,$(_win16p_t)),0)
  W_CPULEVEL=0
endif
ifeq ($(findstring 2,$(_win16p_t)),2)
  W_CPULEVEL=2
endif
ifeq ($(findstring 3,$(_win16p_t)),3)
  W_CPULEVEL=3
endif
ifeq ($(findstring 4,$(_win16p_t)),4)
  W_CPULEVEL=4
endif
ifeq ($(findstring 5,$(_win16p_t)),5)
  W_CPULEVEL=5
endif
ifeq ($(findstring 6,$(_win16p_t)),6)
  W_CPULEVEL=6
endif

ifeq ($(findstring c,$(_win16p_t)),c)
  W_MMODE=c
endif
ifeq ($(findstring s,$(_win16p_t)),s)
  W_MMODE=s
endif
ifeq ($(findstring m,$(_win16p_t)),m)
  W_MMODE=m
endif
ifeq ($(findstring l,$(_win16p_t)),l)
  W_MMODE=l
endif
ifeq ($(findstring h,$(_win16p_t)),h)
  W_MMODE=h
endif
ifeq ($(findstring f,$(_win16p_t)),f)
  W_MMODE=f
endif

ifeq ($(findstring o,$(_win16p_t)),o)
TARGET_CPUONLY=1
endif

ifeq ($(findstring x,$(_win16p_t)),x)
TARGET_EXTLIB=1
endif

ifeq ($(findstring d,$(_win16p_t)),d)
TARGET_DEBUG=1
W_DEBUG=-d3
endif

# compiler flags
_win16p_defs = -dTARGET_WINDOWS=1 -dTARGET_WINDOWS_WIN16=1 -dTARGET_BITS=16 -dTARGET_PROTMODE=1 -dTARGET_CPU=$(W_CPULEVEL) -dTARGET_WINDOWS_GUI=1 -d_WINDOWS_16_=1
ifeq ($(TARGET_CPUONLY),1)
_win16p_defs += -dTARGET_CPUONLY=1
endif
ifeq ($(TARGET_EXTLIB),1)
_win16p_defs += -dTARGET_EXTLIB=1
endif
ifeq ($(TARGET_DEBUG),1)
_win16p_defs += -dTARGET_DEBUG=1
endif
ifneq ($(TARGET_WINDOWS_VERSION),)
_win16p_defs += -dTARGET_WINDOWS_VERSION=$(TARGET_WINDOWS_VERSION)
endif
...
WCCFLAGS=-e=2 -zq -zw -zu -m$(W_MMODE) $(W_DEBUG) -bt=windows -oilrtfm -wx -$(W_CPULEVEL) $(_win16p_defs) -q -fr=nul
WASMFLAGS=-e=2 -zq -zw -zu -m$(W_MMODE) $(W_DEBUG) -bt=windows -wx -$(W_CPULEVEL) $(_win16p_defs) -q
...
WLINKFLAGS=option stack=8192 option heapsize=4096
