...
WCCFLAGS=-e=2 -zq -zw -zu -m$(W_MMODE) $(W_DEBUG) -bt=windows -oilrtfm -wx -$(W_CPULEVEL) $(_win16r_defs) -q -fr=nul
WASMFLAGS=-e=2 -zq -zw -zu -m$(W_MMODE) $(W_DEBUG) -bt=windows -wx -$(W_CPULEVEL) $(_win16r_defs) -q
...
# ^ NTS: Known settings compatible with Windows 2.x and possibly 1.x
