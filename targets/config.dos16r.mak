...
# compiler flags
_d16r_defs = -dTARGET_MSDOS=1 -dTARGET_BITS=16 -dTARGET_REALMODE=1
ifeq ($(TARGET_CPUONLY),1)
_d16r_defs += -dCPUONLY=1
endif
ifeq ($(TARGET_EXTLIB),1)
_d16r_defs += -dEXTLIB=1
endif
ifeq ($(TARGET_DEBUG),1)
_d16r_defs += -dDEBUG=1
endif
...
NASMFLAGS=-DTARGET_MSDOS=1 -DTARGET_BITS=16 -DTARGET_REALMODE=1 -DMMODE=$(W_MMODE) -DCPUONLY=$(TARGET_CPUONLY) -DEXTLIB=$(TARGET_EXTLIB) -DDEBUG=$(TARGET_DEBUG)
WLINK_SYSTEM=dos
